...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.DuplicateOpenIdExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class DuplicateOpenIdExceptionMapper
	extends BaseExceptionMapper<DuplicateOpenIdException> {
